...
import * as auth from "./styled-components/auth-component";
  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
      <auth.Container>
        ...
        >
          <label htmlFor="email" className="text-lg font-bold text-main-green">
            Email
          </label>
          <auth.Input
            id="email"
          ...
          <auth.Input
            ...
            required
          />
          <auth.InputButton type="submit" value="Create connect account" />
        </form>
        <p className="text-sm">
